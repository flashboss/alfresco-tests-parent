    ...
    if (fileToUpload != null) {
      ...
      try {
        ...
        throw new WebScriptException(
            HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "Date format error");
      }
      ...
      try {
        ...
        throw new WebScriptException(
            HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "Unable to create node");
      }
      ...
      try {
        ...
        throw new WebScriptException(
            HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "Unable to add aspects");
      }
    }
