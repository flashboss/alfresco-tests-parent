...
public class ActUtil {
	...
	public static final String CRL_ACTS_MODEL = "http://www.regione.lombardia.it/content/model/acts/1.0";
	public static final QName TYPE_ACT_PDL = QName.createQName(CRL_ACTS_MODEL, "actPdl");
	public static final String PROP_STATO_ACT = "statoAct";
	...
	public static final QName PROP_STATO_ACT_QNAME = QName.createQName(CRL_ACTS_MODEL, PROP_STATO_ACT);
}
