...
/**
 * Mock implementation of the CreateDocTreeTest class for testing purposes. This class provides a
...
public class CreateDocTreeTest extends AbstractWSForm {
  ...
  private static final Log logger = LogFactory.getLog(CreateDocTreeTest.class);
  private static final String ID_PARTNER = "prova";
  private static final String ID_PRATICA = "prova";
  private static final String FOLDER_WSSAMPLE =
  ...
  /** The create doc tree. */
  @Autowired private CreateDocTree createDocTree;
  ...
  public void execute() throws ParseException, IOException {
    ...
    WebScriptRequest webScriptRequest =
        new MockWebScriptRequest("json", templateVars, createDocTree, fields, serviceRegistry);
