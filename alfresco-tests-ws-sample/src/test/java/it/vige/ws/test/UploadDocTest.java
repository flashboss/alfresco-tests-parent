...
/**
 * Mock implementation of the UploadDocTest class for testing purposes. This class provides a mock
...
public class UploadDocTest extends AbstractWSForm {
  ...
  private static final Log logger = LogFactory.getLog(UploadDocTest.class);
  private static final String ID_PARTNER = "prova";
  private static final String ID_PRATICA = "prova";
  private static final String ID_DOC = "prova";
  private static final String NOME_FILE = "unsigned.pdf";
  private static final String DESCRIZIONE = "descrizione.pdf";
  private static final String TRATTAMENTO = "3";
  private static final String DATA_SCADENZA = "2018-04-19";
  private static final String DATA_EMISSIONE = "2018-04-19";
  private static final String DATA_CREAZIONE = "2018-04-23";
  private static final String CODICE_DOC = "461";
  private static final String CATEGORIA_TIPO = "461";
  private static final String NOTE = "note";
  private static final String NUMERO_DOC = "";
  private static final String ID_USER = "105";
  private static final String FOLDER_DROPZONE = "/sites/vige-site/documentLibrary/sys/Dropzone";
  private Map<String, String> templateVars;

  /** The upload doc. */
  @Autowired private UploadDoc uploadDoc;
  ...
  public void execute() throws ParseException, IOException {
    ...
    WebScriptRequest webScriptRequest =
        new MockWebScriptRequest("json", templateVars, uploadDoc, fields, serviceRegistry);
    ...
    for (QName aspect : aspects) {
      if (aspect.equals(ContentModel.ASPECT_TITLED))
        Assert.assertEquals(
            "The signed document looks like the title", ContentModel.ASPECT_TITLED, aspect);
      else if (aspect.equals(ContentModel.ASPECT_VERSIONABLE))
        Assert.assertEquals(
            "The signed document is versionable", ContentModel.ASPECT_VERSIONABLE, aspect);
      else if (aspect.equals(VigeWSContentModel.DOC_ASPECT))
        Assert.assertEquals(
            "The signed document has the vigepmi aspect", VigeWSContentModel.DOC_ASPECT, aspect);
      else Assert.fail();
    }
    ...
    Assert.assertEquals(
        "Treatment", TRATTAMENTO, properties.get(VigeWSContentModel.TRATTAMENTO_DOC));
    ...
    Assert.assertEquals(
        "Type category", CATEGORIA_TIPO, properties.get(VigeWSContentModel.CATEGORIA_TIPO_DOC));
    Assert.assertEquals("Id user", ID_USER, properties.get(VigeWSContentModel.ID_USER));
    Assert.assertEquals(
        "Document number", NUMERO_DOC, properties.get(VigeWSContentModel.NUMERO_DOC));
