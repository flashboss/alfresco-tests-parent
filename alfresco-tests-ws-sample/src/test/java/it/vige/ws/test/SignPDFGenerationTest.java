...
/**
 * Mock implementation of the SignPDFGenerationTest class for testing purposes. This class provides
...
public class SignPDFGenerationTest extends AbstractWSForm {
  ...
  private static final Log logger = LogFactory.getLog(SignPDFGenerationTest.class);
  private static final String ID_PARTNER = "prova";
  private static final String ID_PRATICA = "prova";
  private static final String DRL_NAME = "rf_006";
  private static final String MESE_PRATICA = "01";
  private static final String ANNO_PRATICA = "1980";
  private static final String ID_DOC = "idddddd";
  private static final String FOLDER_RISULTATO =
      "/sites/vige-site/documentLibrary/Questions/"
          + ID_PARTNER
          + "/"
          + ANNO_PRATICA
          + "/"
  ...
  /** The sign pdf generation. */
  @Autowired private SignPDFGeneration signPDFGeneration;
  ...
  public void init() {
    ...
    InputStream content =
        this.getClass().getClassLoader().getResourceAsStream("rules/" + DRL_NAME + ".drl");
    try {
  ...
  public void execute() throws ParseException, IOException {
    ...
    InputStream jsonStream =
        this.getClass().getClassLoader().getResourceAsStream("json_lecters.json");
    ...
    WebScriptRequest webScriptRequest =
        new MockWebScriptRequest("json", templateVars, signPDFGeneration, fields, serviceRegistry);
    ...
    for (QName aspect : aspects) {
      if (aspect.equals(ContentModel.ASPECT_TITLED))
        ...
        Assert.assertEquals(
            "The signed document looks like the doc", VigeWSContentModel.DOC_ASPECT, aspect);
