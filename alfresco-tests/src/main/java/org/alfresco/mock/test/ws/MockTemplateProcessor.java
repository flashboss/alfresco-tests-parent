...
/**
 * Mock implementation of the MockTemplateProcessor class for testing purposes. This class provides
...
public class MockTemplateProcessor implements TemplateProcessor {
  ...
  public void process(String template, Object model, Writer out) {
    if (model instanceof Map) ((MockWriter) out).setModel((Map<String, Object>) model);
  }
