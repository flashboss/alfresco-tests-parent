...
/**
 * Mock implementation of the MockNamespaceService class for testing purposes. This class provides a
...
public class MockNamespaceService implements NamespaceService, Serializable {
  ...
  public Collection<String> getPrefixes(String namespaceURI) throws NamespaceException {
    ...
    for (String prefix : prefixes.keySet())
      if (prefixes.get(prefix).equals(namespaceURI)) results.add(prefix);
    return results;
  }
