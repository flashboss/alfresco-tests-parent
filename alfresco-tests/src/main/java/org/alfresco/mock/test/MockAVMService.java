...
public class MockAVMService implements AVMService {
	...
	@Override
	public void createFile(String path, String name, InputStream in, List<QName> aspects,
	...
	@Override
	public SortedMap<String, AVMNodeDescriptor> getDirectoryListingDirect(AVMNodeDescriptor dir,
			boolean includeDeleted) {
		// TODO Auto-generated method stub
		return null;
	}
