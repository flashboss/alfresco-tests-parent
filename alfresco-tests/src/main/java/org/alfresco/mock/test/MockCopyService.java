...
/**
 * Mock implementation of the MockCopyService class for testing purposes. This class provides a mock
...
public class MockCopyService implements CopyService, Serializable {
  ...
  @Override
  public NodeRef copy(
      NodeRef sourceNodeRef, NodeRef targetParentNodeRef, QName assocTypeQName, QName assocQName) {
  ...
  public PagingResults<CopyInfo> getCopies(
      NodeRef originalNodeRef, NodeRef copyParentNodeRef, PagingRequest pagingRequest) {
    // TODO Auto-generated method stub
    return null;
  }
  ...
  /** {@inheritDoc} */
  @Override
  public String getTopLevelNodeNewName(
      NodeRef sourceNodeRef, NodeRef targetParentRef, QName assocTypeQName, QName assocQName) {
    // TODO Auto-generated method stub
    return null;
  }
}
