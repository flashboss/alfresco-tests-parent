...
/**
 * Mock implementation of the MockSolrFacetHelper class for testing purposes. This class provides a
...
public class MockSolrFacetHelper extends SolrFacetHelper implements Serializable {
  ...
  /**
   * Constructs a new MockSolrFacetHelper instance.
   *
   * @param facetQueryProviders the facetQueryProviders
   */
