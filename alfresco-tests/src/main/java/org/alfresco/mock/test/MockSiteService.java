...
/**
 * Mock implementation of the MockSiteService class for testing purposes. This class provides a mock
...
public class MockSiteService implements SiteService, Serializable {
  ...
  public PagingResults<SiteGroupMembership> listGroupMembersPaged(
      String shortName, List<Pair<SortFields, Boolean>> sortProps, PagingRequest pagingRequest) {
    // TODO Auto-generated method stub
    return null;
  }
