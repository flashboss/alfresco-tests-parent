...
/**
 * Abstract base class for web script form-based tests. This class provides common functionality for
 * testing Alfresco web scripts using mock services without requiring a full server instance.
 *
 * @author Generated
 * @version 7.4.2.1.1
 */
