...
/**
 * Utility class providing static helper methods for creating and manipulating nodes in a mock
 * Alfresco repository.
 *
 * @author vige
 */
    ...
    NodeRef node =
        nodeService
            .createNode(
                ...
                QName.createQName(NamespaceService.CONTENT_MODEL_PREFIX, name, namespaceService),
                type,
                properties)
            .getChildRef();
