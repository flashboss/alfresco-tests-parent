...
```
You can find a complete sample in https://github.com/flashboss/alfresco-tests-parent/tree/7.1.0.3/alfresco-tests-sample.
...
```
You can find a complete sample in https://github.com/flashboss/alfresco-tests-parent/tree/7.1.0.3/alfresco-tests-activiti-sample.
...
```
You can find a complete sample in https://github.com/flashboss/alfresco-tests-parent/tree/7.1.0.3/alfresco-tests-ws-sample.
