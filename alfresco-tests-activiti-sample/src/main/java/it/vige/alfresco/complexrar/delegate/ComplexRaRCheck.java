...
/**
 * Mock implementation of the ComplexRaRCheck class for testing purposes. This class provides a mock
  ...
  public void execute(DelegateExecution execution) throws Exception {
    ...
    for (ChildAssociationRef relatedSaSChild : relatedSaSsChild) {
      ...
      if (sass.containsKey(relatedSaSNodeRef.toString())) {
        ...
        String sasHash =
            (String) nodeService.getProperty(relatedSaSNodeRef, HashModel.PROP_HASH_VALUE);
