...
/**
 * Mock implementation of the ComplexRaRStoring class for testing purposes.
...
public class ComplexRaRStoring extends ComplexRaRGeneration {
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		ChildAssociationRef childAssRef = nodeService.createNode(rarFolderNodeRef, ContentModel.ASSOC_CONTAINS,
				QName.createQName(NamespaceService.CONTENT_MODEL_1_0_URI, rarNodeName), ConservationModel.TYPE_RAR,
				rarProps);
		...
		for (ChildAssociationRef relatedSaSChild : relatedSaSsChild) {
			...
			NodeRef relateISaSNodeRef = nodeService.getChildByName(relateSaSParentNodeRef, ContentModel.ASSOC_CONTAINS,
					relatedISaSName);
