 ...
 * generated in the it.vige.nam.stub package.
 *
...
public class ObjectFactory {
  ...
  private static final QName _SignCAdESByAttachment_QNAME =
      new QName("http://service.ws.nam/", "signCAdESByAttachment");
  private static final QName _SignCAdESByAttachmentResponse_QNAME =
      new QName("http://service.ws.nam/", "signCAdESByAttachmentResponse");
  private static final QName _VerifyCAdESByAttachment_QNAME =
      new QName("http://service.ws.nam/", "verifyCAdESByAttachment");
  private static final QName _VerifyCAdESByAttachmentResponse_QNAME =
      new QName("http://service.ws.nam/", "verifyCAdESByAttachmentResponse");
  private static final QName _WSException_QNAME =
      new QName("http://service.ws.nam/", "WSException");

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes
   * for package: it.vige.nam.stub
   */
  ...
  /** Create an instance of {@link JAXBElement }{@code <}{@link SignCAdESByAttachment }{@code >}} */
  @XmlElementDecl(namespace = "http://service.ws.nam/", name = "signCAdESByAttachment")
  public JAXBElement<SignCAdESByAttachment> createSignCAdESByAttachment(
      SignCAdESByAttachment value) {
    return new JAXBElement<SignCAdESByAttachment>(
        _SignCAdESByAttachment_QNAME, SignCAdESByAttachment.class, null, value);
  }
  ...
  public JAXBElement<SignCAdESByAttachmentResponse> createSignCAdESByAttachmentResponse(
    ...
    return new JAXBElement<SignCAdESByAttachmentResponse>(
        _SignCAdESByAttachmentResponse_QNAME, SignCAdESByAttachmentResponse.class, null, value);
  }

  /**
   * Create an instance of {@link JAXBElement }{@code <}{@link VerifyCAdESByAttachment }{@code >}}
   */
  @XmlElementDecl(namespace = "http://service.ws.nam/", name = "verifyCAdESByAttachment")
  public JAXBElement<VerifyCAdESByAttachment> createVerifyCAdESByAttachment(
      VerifyCAdESByAttachment value) {
    return new JAXBElement<VerifyCAdESByAttachment>(
        _VerifyCAdESByAttachment_QNAME, VerifyCAdESByAttachment.class, null, value);
  }
  ...
  public JAXBElement<VerifyCAdESByAttachmentResponse> createVerifyCAdESByAttachmentResponse(
    ...
    return new JAXBElement<VerifyCAdESByAttachmentResponse>(
        _VerifyCAdESByAttachmentResponse_QNAME, VerifyCAdESByAttachmentResponse.class, null, value);
  }
