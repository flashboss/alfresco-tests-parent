...
@WebServiceClient(
    name = "SignIntegrationService",
    wsdlLocation = "classpath:wsdl/SignIntegrationService.wsdl",
    targetNamespace = "http://service.ws.nam/")
/**
 * This class was generated by Apache CXF 3.1.11 2017-04-20T12:22:19.914+02:00 Generated source
 * version: 3.1.11
 */
public class SignIntegrationService extends Service {
  ...
  public static final QName SERVICE = new QName("http://service.ws.nam/", "SignIntegrationService");
  public static final QName SignIntegrationPort =
      new QName("http://service.ws.nam/", "SignIntegrationPort");
  ...
  static {
    ...
    url =
        SignIntegrationService.class
            .getClassLoader()
            .getResource("wsdl/SignIntegrationService.wsdl");
    if (url == null) {
      java.util.logging.Logger.getLogger(SignIntegrationService.class.getName())
          .log(
              java.util.logging.Level.INFO,
              "Can not initialize the default wsdl from {0}",
              "classpath:wsdl/SignIntegrationService.wsdl");
    }
    WSDL_LOCATION = url;
  }
