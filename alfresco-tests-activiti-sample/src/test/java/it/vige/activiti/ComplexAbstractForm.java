...
/**
 * Mock implementation of the ComplexAbstractForm class for testing purposes. This class provides a
...
public class ComplexAbstractForm extends AbstractActivitiForm {
  ...
  public static final String ACTIVITY_KEY = "complexRarGenerationWorkflow";

  public static final String CONTRIBUTORS = "contributors";

  /** Default admin user to start the scheduler process */
  protected static final String ADMIN_USER_NAME = "kermit";

  /** Default traveler user to work with the reservations */
  protected static final String USER_NAME = "gonzo";
  ...
  public void init(Map<String, Object> variables) {
    ...
    try {
      ...
      properties.put(
          ...
          QName.createQName("vigecont", "complexPdvCons", namespaceService));
      insertZip(
          generationFolder,
          "sas_complex_" + generationFolderName + ".zip",
          "document",
          "text",
          properties);
    } catch (IOException e) {
    ...
    insertDocument(
        generationFolder, "isas_complex_" + generationFolderName + ".xml", "", properties);
    // AUTHENTICATION
