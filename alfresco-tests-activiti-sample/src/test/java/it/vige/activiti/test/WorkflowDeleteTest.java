...
/**
 * Mock implementation of the WorkflowDeleteTest class for testing purposes. This class provides a
 ...
 * @version 7.4.2.1.1
 */
public class WorkflowDeleteTest extends ComplexAbstractForm {
  ...
  public void testHuman() throws ParseException {
    ...
    secondTaskLocalVariables.put("vigewf_reviewRaR", "Cancella RaR");
